...
var GroupVersion = schema.GroupVersion{Group: "actions.stacks.org", Version: "v1alpha1"}
...
type BitcoinBlockGenerationSpec struct {
	...
	// BitcoinNodeRef names the exact compiled BitcoinNode, not a Pod or Service.
