...
func TestVocabularyWireValues(t *testing.T) {
	for _, tc := range []struct {
		...
		{"ReasonContractObservationUnavailable", ReasonContractObservationUnavailable, `"ContractObservationUnavailable"`},
		...
		{"ReasonPrepareBitcoinObservationDeadline", ReasonPrepareBitcoinObservationDeadline, `"PrepareBitcoinObservationDeadline"`},
