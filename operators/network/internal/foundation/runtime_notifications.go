...
func runtimeNotifications(c client.Client) handler.TypedEventHandler[client.Object, networkRequest] {
	...
	enqueue := func(ctx context.Context, obj client.Object, q workqueue.TypedRateLimitingInterface[networkRequest], delay time.Duration) {
	...
	return handler.TypedFuncs[client.Object, networkRequest]{
		CreateFunc: func(ctx context.Context, e event.CreateEvent, q workqueue.TypedRateLimitingInterface[networkRequest]) {
			enqueue(ctx, e.Object, q, 0)
		},
		DeleteFunc: func(ctx context.Context, e event.DeleteEvent, q workqueue.TypedRateLimitingInterface[networkRequest]) {
			enqueue(ctx, e.Object, q, 0)
		},
		GenericFunc: func(ctx context.Context, e event.GenericEvent, q workqueue.TypedRateLimitingInterface[networkRequest]) {
			enqueue(ctx, e.Object, q, 0)
		},
		UpdateFunc: func(ctx context.Context, e event.UpdateEvent, q workqueue.TypedRateLimitingInterface[networkRequest]) {
