...
func TestLiveFiniteGeneration(t *testing.T) {
	...
	paused := waitProduction(t, c, key, func(p *bitcoinv1.BitcoinBlockProduction) bool {
	...
	waitProduction(t, c, key, func(p *bitcoinv1.BitcoinBlockProduction) bool { return p.Status.Action == nil })
	updateNetwork(t, ctx, c, key, func(n *networkv1.StacksNetwork) {
		n.Spec.BitcoinBlockProduction.Paused = false
		n.Spec.StacksNodes = nil
	})
	waitProduction(t, c, key, func(p *bitcoinv1.BitcoinBlockProduction) bool { return p.Status.BlocksProduced >= baseline+2 })
...
func TestLiveGenerationInFlightShutdown(t *testing.T) {
	...
	waitBitcoinFixtureLog(t, key, "delaying delivery for 15 seconds")
	armed := &bitcoinv1.BitcoinBlockProduction{}
	liveMust(t, c.Get(ctx, key, armed))
