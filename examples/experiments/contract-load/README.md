...
These reusable contract examples generate nested calls and map read/write load.
They are external workload inputs, not an operator workload or scenario controller.
...
keys measures updates. Record selected sizes and batch counts with experiment evidence.
